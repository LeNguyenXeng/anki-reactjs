...
function Privacy() {
  return (
    <Container>
      ...
      <div>
        <h2>Who we are</h2>
        <p className="dis-privacy">
          In this Privacy Policy, ‘us’ ‘we’ or ‘our’ means Anki Education. We
          are committed to respecting your privacy. Our Privacy Policy sets outs
          ...
          by publishing changes to it on our website. We encourage you to check
          our website periodically to ensure that you are aware of our current
          Privacy Policy.
        </p>
      </div>
      <div>
        ...
        <ul className="ul-privacy">
          <li>
            ...
            mobile device and connection information, statistics on page views,
            traffic to and from the sites, ad data, IP address and standard web
            log information;
          </li>
          <li>
        ...
        <p className="dis-privacy">
          ...
          directly through our website or app or indirectly through your use of
          our website or app or online presence or through other websites or
          accounts from which you permit us to collect information; information
          you provide to us through customer surveys; or any other personal
          information that may be required in order to facilitate your dealings
          with us
        </p>
      </div>
      <div>
        <h2>We may collect this information when you:</h2>
        <ul className="ul-privacy">
        ...
        <p className="dis-privacy">
          ...
          recruitment consultant, your previous employers and others who may be
          able to provide information to us to assist in our decision on whether
          or not to make you an offer of employment or engage you under a
          contract. This Privacy Policy does not apply to acts and practices in
          relation to employee records of our current and former employees,
      ...
      <div>
        ...
        <ul className="ul-privacy">
          ...
          <li>
            To operate, protect, improve and optimize our website, services and
            app, business and our users’ experience, such as to perform
            analytics, conduct research and for advertising and marketing; to
            send you service, support and administrative messages, reminders,
            technical notices, updates, security alerts, and the information
            requested by you;
          </li>
          <li>
            To send you marketing and promotional messages and other information
            that may be of interest to you, including information sent by, or on
            behalf of, our business partners that we think you may find
            interesting;
          </li>
          <li>
        ...
        <p className="dis-privacy">
          ...
          anonymised consumer insights so that we can better understand your
          preferences and interests, personalize your experience and enhance the
      ...
      <div>
        ...
        <p className="dis-privacy">
          ...
          the comments form and the visitor’s IP address and browser user agent
          ...
          policy is available here: https://automattic.com/privacy/. After
      ...
      <div>
        ...
        <p className="dis-privacy">
          Traditionally, cookies and information obtained from cookies are not
          treated as personal information if they cannot identify an individual.
          However, with the increasing complexity of cookies and the data that
          may be collected by cookies, some cookies and the data collected may
          qualify as personal information. Please consider whether any cookies
          that your company uses will collect personal information. We may
          collect your personal information when you use and access our website.
          While we do not use browsing information to identify you personally,
          we may record certain information about your use of our website, such
          as which pages you visit, the time and date of your visit and the

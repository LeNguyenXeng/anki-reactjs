    ...
    <Container>
      ...
      <div>
        <p className="p-service">
          ...
          Anki Education mobile application (the “Service”). <br /> This page
          ...
          you have associated with that data. <br /> We use your data to provide
          and improve the Service. By using the Service, you agree to the
          collection and use of information in accordance with this policy.
          Unless otherwise defined <br /> in this Privacy Policy, terms used in
      ...
      <div>
        ...
        <p className="p-ser">
          Service means the{" "}
          <a href="https://anki.edu.vn/">https://anki.edu.vn</a> website and the
          Anki Education mobile application operated by Anki Education, LLC.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className="p-ser2">
          ...
          identify you (“Personal Data”). Personally <br /> identifiable information
          may include, but is not limited to: <br /> First name and last name <br /> Email
          address <br /> Cookies and Usage Data <br /> We may use your Personal Data to
          contact you with newsletters, marketing or promotional materials and
          other information that may be of interest to you. <br /> You may opt out of
